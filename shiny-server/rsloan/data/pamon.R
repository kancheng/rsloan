...
# pamon( im08, hacbdt, pkb, pamkc = 6, dtname = "im08")
...
#	piophdn = paste0( dtname, ".png")
	par( mfrow = c( 1, 2))
	plot(pamcal, data = dhdc)
}

# pamon2( im08, hacbdt, pkb, pamkc = 6, dtname = "im08")